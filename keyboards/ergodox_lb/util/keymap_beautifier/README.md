...
Optionally, it can also render [LAYOUT_ergodox_pretty](https://github.com/qmk/qmk_firmware/blob/ee700b2e831067bdb7584425569b61bc6329247b/keyboards/ergodox_lb/keymaps/bpruitt-goddard/keymap.c#L49-L57):
```
...
```
cd QMK_GIT_REPO_dir/keyboards/ergodox_lb/util/keymap_beautifier
